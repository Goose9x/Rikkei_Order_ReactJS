      ...
      <div className='sale-col'>
        <div className='sale-food-card card'>
          ...
          <div className='item-info'>
            <div className="box-img"><img src="https://firebasestorage.googleapis.com/v0/b/ra-order.appspot.com/o/images%2FMi-tre-em.png?alt=media&token=dedee46c-232a-40b4-a215-02c25899ddde" className='card-img-top' alt='...' /></div>
