      ...
      <div className='sale-col'>
        <div className='sale-food-card card'>
          ...
          <div className='item-info'>
           <div className="box-img"> <img src="https://firebasestorage.googleapis.com/v0/b/ra-order.appspot.com/o/images%2Fbanh-cosy.png?alt=media&token=e3de5de1-8d08-46de-b942-a85021ef5cc5" className='card-img-top' alt='...' /></div>
