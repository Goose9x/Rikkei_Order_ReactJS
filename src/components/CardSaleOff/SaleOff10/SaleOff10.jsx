      ...
      <div className='sale-col'>
        <div className='sale-food-card card'>
          ...
          <div className='item-info'>
            <div className="box-img"><img src="https://firebasestorage.googleapis.com/v0/b/ra-order.appspot.com/o/images%2Ftobuki.png?alt=media&token=3d2e597b-2766-4400-ae16-62ce6db338e7" className='card-img-top' alt='...' /></div>
