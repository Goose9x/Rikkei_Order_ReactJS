      ...
      <div className='sale-col'>
        <div className='sale-food-card card'>
          ...
          <div className='item-info'>
            <div className="box-img"><img src="https://firebasestorage.googleapis.com/v0/b/ra-order.appspot.com/o/images%2Fthit-ho.png?alt=media&token=4e9acae1-2002-4624-ad0f-e4402191f9ac" className='card-img-top' alt='...' /></div>
