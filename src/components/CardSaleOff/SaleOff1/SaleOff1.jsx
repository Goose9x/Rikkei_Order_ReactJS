      ...
      <div className='sale-col'>
        <div className='sale-food-card card'>
          ...
          <div className='item-info'>
            <div className="box-img"><img src="https://firebasestorage.googleapis.com/v0/b/ra-order.appspot.com/o/images%2Fbanh-cay.png?alt=media&token=39aeb84d-83ae-401c-b76d-cc98697f3cfd" className='card-img-top' alt='...' /></div>
