      ...
      <div className='col'>
        <div className='food-card card'>
          ...
          <div className='item-info'>
            <div className="box-img"><img src="https://firebasestorage.googleapis.com/v0/b/ra-order.appspot.com/o/images%2Fbanh-dua.png?alt=media&token=a6713214-a47c-4906-8fa3-0c2ce0a13eac" className='card-img-top1' alt='...' /></div>
