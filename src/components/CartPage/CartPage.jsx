...
function Cart() {
  const cartList = [
    {
      id: 1,
      image:
        "https://gaixinhbikini.com/wp-content/uploads/2022/08/baifern-kunthada-12.jpg",
      price: 25000,
      name: "Nâng mắt",
      quantity: 1,
    },
    {
      id: 2,
      image:
        "https://anhgaisexy.com/wp-content/uploads/2021/10/20210818-thipsuda-jitaree-8-617x847.jpg",
      price: 15000,
      name: "Nâng chân",
      quantity: 1,
    },
    {
      id: 3,
      image:
        "https://bedental.vn/wp-content/uploads/2022/11/f99a5cc9ebcceba1dd49af0d509732dc.jpg",
      price: 35000,
      name: "Nâng tai",
      quantity: 1,
    },
    {
      id: 4,
      image:
        "https://gentlenobra.com/wp-content/uploads/2022/03/gai-xinh-mac-bikini-mau-trang-1.jpg",
      price: 35000,
      name: "Nâng ngực",
      quantity: 1,
    },
  ...
  const sum1 = cartList.reduce((pre, x) => pre + x.price * x.quantity, 0);
  ...
  const handleChange = (value, id) => {
    ...
    const newSum = data.reduce(
      (pre, x) => pre + x.price * x.quantity, //method tìm hiểu hàm này
      0
    );
    setSum(newSum);
  };
